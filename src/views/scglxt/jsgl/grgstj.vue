  ...
  <div class="grgstj">
    ...
    >
      <el-table-column align="center" label="工艺过程卡明细">
        ...
        <el-table-column key="ddmc" min-width="130" prop="ddmc" align="center" label="项目名称"></el-table-column>
        <el-table-column min-width="160" align="left" key="bommc" prop="bommc" label="零件名称">
          <template slot-scope="scope">
            <a
              @click="openJgjl(scope.row.id)"
              style="text-align:left;cursor:pointer;"
              v-html="scope.row.bommc"
            ></a>
          </template>
        </el-table-column>
