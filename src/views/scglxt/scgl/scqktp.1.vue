<template>
  <div class="blkcgl">
    ...
    <el-pagination style="text-align:center;margin-top:10px;" background layout="total, prev, pager, next" @current-change="currentChange" :current-page="query.pageNumber" :page-size="query.pageSize" :total="query.total">
    </el-pagination>
  </div>
</template>
